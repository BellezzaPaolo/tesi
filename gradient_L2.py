...
for h in h_v:
    for tau in tau_v:
        for beta in beta_v:
            ...
            mesh, W, u_ex = utils.load_ground_truth(filename)
            ...
            for i in range(MaxIter):
                ...
                error = fd.errornorm(uh, u_ex,'L2')/fd.norm(u_ex,'L2')
                ...
                if error < toll:
                    ...
                    print()
                    print(f'Final energy estimate: {e_gs} and associated lambda: {lamb_gs} with h: {h}, tau: {tau} and beta: {beta}, Iter: {i}')
                    break
